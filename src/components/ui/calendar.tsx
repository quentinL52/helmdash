  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: "flex justify-start pt-1 relative items-center gap-2 px-1",
        caption_label: "text-sm font-semibold",
        nav: "flex items-center gap-1",
        nav_button: cn(
          buttonVariants({ variant: "ghost" }),
          "h-7 w-7 bg-transparent p-0 opacity-60 hover:opacity-100 hover:bg-muted/50 rounded-lg transition-all"
        ),
        nav_button_previous: "",
        nav_button_next: "",
